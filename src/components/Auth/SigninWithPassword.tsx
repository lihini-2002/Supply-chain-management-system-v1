          ...
          <span className="absolute right-4.5 top-1/2 -translate-y-1/2">
            ...
            >
              <path
                ...
                fill="#4A5568" // Specify fill color
              />
            </svg>
          </span>
        </div>
          ...
          <span className="absolute right-4.5 top-1/2 -translate-y-1/2">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M11 1.375C7.09644 1.375 4 4.47144 4 8.375V10.375H2.375V19.375H19.625V10.375H18V8.375C18 4.47144 14.9036 1.375 11 1.375ZM5.625 8.375C5.625 5.61225 8.23725 3 11 3C13.7627 3 16.375 5.61225 16.375 8.375V10.375H5.625V8.375ZM3.875 18V11.875H18.125V18H3.875ZM11 12.25C10.5178 12.25 10.125 12.6428 10.125 13.125V15.875C10.125 16.3572 10.5178 16.75 11 16.75C11.4822 16.75 11.875 16.3572 11.875 15.875V13.125C11.875 12.6428 11.4822 12.25 11 12.25Z"
                fill="#4A5568" // Specify fill color
              />
            </svg>
          </span>
